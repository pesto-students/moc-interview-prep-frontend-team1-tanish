...
function DashboardCard ({description, value}){
    return(
        <span  class="block p-4  bg-white rounded-lg border border-rose-300 shadow-md hover:bg-rose-50 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-44">
